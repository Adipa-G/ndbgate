    ...
    public class DbGateInheritancePersistTests
    {
        ...
        public static void Before()
        {
            try
            {
                ...
                LogManager.GetLogger(typeof (DbGateInheritancePersistTests)).Info("Starting in-memory database for unit tests");
            ...
            {
                LogManager.GetLogger(typeof (DbGateInheritancePersistTests)).Fatal("Exception during database startup.", ex);
            }
        }
                ...
                for (int i = 0; i < types.Length; i++)
                {
                    ...
                    switch (type)
                    {
                        case TYPE_ANNOTATION:
                            LogManager.GetLogger(typeof (DbGateInheritancePersistTests)).Info("Inheritance_Insert_WithAllModesWithBothSubClasses_ShouldEqualWhenLoaded With annotations");
                            break;
                        case TYPE_EXTERNAL:
                            LogManager.GetLogger(typeof (DbGateInheritancePersistTests)).Info("Inheritance_Insert_WithAllModesWithBothSubClasses_ShouldEqualWhenLoaded With externals");
                            break;
                        case TYPE_FIELD:
                            LogManager.GetLogger(typeof (DbGateInheritancePersistTests)).Info("Inheritance_Insert_WithAllModesWithBothSubClasses_ShouldEqualWhenLoaded With fields");
                            break;
                    }
        ...
        public void Inheritance_Update_WithAllModesWithBothSubClasses_ShouldEqualWhenLoaded()
        {
            try
            {
                ...
                for (int i = 0; i < types.Length; i++)
                {
                    ...
                    {
                        case TYPE_ANNOTATION:
                            LogManager.GetLogger(typeof (DbGateInheritancePersistTests)).Info("Inheritance_Update_WithAllModesWithBothSubClasses_ShouldEqualWhenLoaded With annotations");
                            break;
                        case TYPE_EXTERNAL:
                            LogManager.GetLogger(typeof (DbGateInheritancePersistTests)).Info("Inheritance_Update_WithAllModesWithBothSubClasses_ShouldEqualWhenLoaded With externals");
                            break;
                        case TYPE_FIELD:
                            LogManager.GetLogger(typeof (DbGateInheritancePersistTests)).Info("Inheritance_Update_WithAllModesWithBothSubClasses_ShouldEqualWhenLoaded With fields");
                            break;
                    }
        ...
        public void Inheritance_Delete_WithAllModesWithBothSubClasses_ShouldDelete()
        {
            try
            {
                ...
                for (int i = 0; i < types.Length; i++)
                {
                    ...
                    {
                        case TYPE_ANNOTATION:
                            LogManager.GetLogger(typeof (DbGateInheritancePersistTests)).Info("Inheritance_Delete_WithAllModesWithBothSubClasses_ShouldDelete With annotations");
                            break;
                        case TYPE_EXTERNAL:
                            LogManager.GetLogger(typeof (DbGateInheritancePersistTests)).Info("Inheritance_Delete_WithAllModesWithBothSubClasses_ShouldDelete With externals");
                            break;
                        case TYPE_FIELD:
                            LogManager.GetLogger(typeof (DbGateInheritancePersistTests)).Info("Inheritance_Delete_WithAllModesWithBothSubClasses_ShouldDelete With fields");
                            break;
                    }
