...
using dbgate.ermanagement.support.persistant.constraint;
using log4net;
    ...
    public class ErManagementConstraintValidationTest
    {
        ...
        public static void Before()
        {
            try
            {
                ...
                LogManager.GetLogger(typeof (ErManagementConstraintValidationTest)).Info("Starting in-memory database for unit tests");
            ...
            {
                LogManager.GetLogger(typeof (ErManagementConstraintValidationTest)).Fatal("Exception during database startup.", ex);
            }
        }
        ...
        public static void After()
        {
            ...
            {
                LogManager.GetLogger(typeof (ErManagementConstraintValidationTest)).Fatal("Exception during test cleanup.", ex);
            }
        }
        ...
        public void ConstraintValidation_DeleteOneToOneChild_WithReverseRelationShip_ShouldNotDeleteChild()
        {
            ...
            {
                LogManager.GetLogger(typeof(ErManagementConstraintValidationTest)).Fatal(e.Message,e);
