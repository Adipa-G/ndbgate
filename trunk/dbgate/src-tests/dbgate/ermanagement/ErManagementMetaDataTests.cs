...
using dbgate.ermanagement.support.metadata;
using log4net;
    ...
    public class ErManagementMetaDataTests
    {
        ...
        public static void Before()
        {
            try
            {
                ...
                LogManager.GetLogger(typeof (ErManagementMetaDataTests)).Info("Starting in-memory database for unit tests");
            ...
            {
                LogManager.GetLogger(typeof (ErManagementMetaDataTests)).Fatal("Exception during database startup.", ex);
            }
        }
        ...
        public void BeforeEach()
        {
            ...
            {
                LogManager.GetLogger(typeof(ErManagementMetaDataTests)).Fatal("Exception during test initialization.", ex);
            }
        }
