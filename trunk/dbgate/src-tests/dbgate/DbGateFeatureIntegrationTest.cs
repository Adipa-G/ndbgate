    ...
    public class DbGateFeatureIntegrationTest
    {
        ...
        public static void Before()
        {
            try
            {
                ...
                LogManager.GetLogger(typeof (DbGateFeatureIntegrationTest)).Info("Starting in-memory database for unit tests");
            ...
            {
                LogManager.GetLogger(typeof (DbGateFeatureIntegrationTest)).Fatal("Exception during database startup.", ex);
            }
        }
