...
namespace DbGate.Exceptions
{
    public class IncorrectFieldDefinitionException : DbGateException
    {
        ...
        public IncorrectFieldDefinitionException(string message, Exception innerException)
            : base(message, innerException)
        {
        }

        protected IncorrectFieldDefinitionException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
