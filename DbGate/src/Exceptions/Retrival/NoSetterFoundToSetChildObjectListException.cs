...
namespace DbGate.Exceptions.Retrival
{
    public class NoSetterFoundToSetChildObjectListException : DbGateException
    {
        ...
        public NoSetterFoundToSetChildObjectListException(string message, Exception innerException)
            : base(message, innerException)
        {
        }

        protected NoSetterFoundToSetChildObjectListException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
